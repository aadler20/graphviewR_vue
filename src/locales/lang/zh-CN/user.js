export default {
  ...
  'user.login.username.placeholder': '您的用户ID',
  'user.login.password.placeholder': '您的密码',
  'user.login.message-invalid-credentials': '用户ID或密码错误',
  ...
  'user.username.required': '请输入用户姓名！',
